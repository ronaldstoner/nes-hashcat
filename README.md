...
src/
  ...
  md.c        MD4 + MD5        sha1.c  SHA-1        sha256.c  SHA-256
  crc32.c     CRC-32           brute.c a-z odometer  sound.c  APU engine
  text.c      nametable + VRAM-update-buffer helpers
  chr.c, gen_title.h   GENERATED by tools/gen_chr.py
tools/gen_chr.py, font8x8_basic.h, hashtest.c
references/  hashcatlogo.png
```
